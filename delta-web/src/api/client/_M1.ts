...
export async function getObjectStorageEvents(): Promise<ObjectStorageEventView[]> {
    const _response: any = await _createHttp().get(_Monitoring_GET_GetObjectStorageEvents_url());
...
export async function getProcessorNodeEvents(): Promise<ProcessorNodeEventView[]> {
    const _response: any = await _createHttp().get(_Monitoring_GET_GetProcessorNodeEvents_url());
...
export async function getJobEvents(): Promise<JobEventView[]> {
    const _response: any = await _createHttp().get(_Monitoring_GET_GetJobEvents_url());
