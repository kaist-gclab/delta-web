...
import { AssetType, CreateAssetTypeRequest } from './_types';
import { _convert__api_AssetType_TO_AssetType_Array, _convert_CreateAssetTypeRequest_TO__api_CreateAssetTypeRequest } from './_converters';
...
export async function getAssetTypes(): Promise<AssetType[]> {
    ...
    return _restoreCircularReferences(_convert__api_AssetType_TO_AssetType_Array(_response.data), _createObject);
}
