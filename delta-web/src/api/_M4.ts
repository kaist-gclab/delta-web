...
import { ProcessorNode, _api_ProcessorNode, RegisterProcessorNodeRequest, _api_RegisterProcessorNodeRequest, Object } from './_types';
...
export async function getNodes(): Promise<ProcessorNode[]> {
    ...
    return restoreCircularReferences(_convert__api_ProcessorNode_TO_ProcessorNode_Array(_response.data), _createObject);
}
...
export async function registerProcessorNode(registerProcessorNodeRequest: RegisterProcessorNodeRequest): Promise<ProcessorNode> {
    ...
    return restoreCircularReferences(_convert__api_ProcessorNode_TO_ProcessorNode(_response.data), _createObject);
}
