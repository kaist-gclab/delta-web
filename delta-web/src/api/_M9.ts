...
export async function getEncryptionKeys(): Promise<EncryptionKey[]> {
    ...
    return restoreCircularReferences(_convert__api_EncryptionKey_TO_EncryptionKey_Array(_response.data), _createObject);
}
...
export async function create(createEncryptionKeyRequest: CreateEncryptionKeyRequest): Promise<CreateEncryptionKeyResponse> {
    ...
    return restoreCircularReferences(_convert__api_CreateEncryptionKeyResponse_TO_CreateEncryptionKeyResponse(_response.data), _createObject);
}
