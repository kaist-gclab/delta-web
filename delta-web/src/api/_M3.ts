...
export async function home(): Promise<string> {
    ...
    return restoreCircularReferences(_convert_string_TO_string(_response.data), _createObject);
}
...
export async function apiHome(): Promise<ApiHomeResponse> {
    ...
    return restoreCircularReferences(_convert__api_ApiHomeResponse_TO_ApiHomeResponse(_response.data), _createObject);
}
