...
import { _convert__api_JobType_TO_JobType_Array } from './_converters';
...
export async function getJobTypes(): Promise<JobType[]> {
    ...
    return _restoreCircularReferences(_convert__api_JobType_TO_JobType_Array(_response.data), _createObject);
}
